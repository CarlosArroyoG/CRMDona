...
| 16 | Límites de negocio de donativos en línea (mínimo y máximo) | [D] DECISIÓN DE NEGOCIO | Después del sandbox | Hoy vacíos: solo aplica el técnico (Stripe 10 MXN; Mercado Pago sin verificar) |
| 17 | Comportamiento de la pausa en Stripe (`pause_collection.behavior = void`: el periodo pausado no genera adeudo) | [D] DECISIÓN DE NEGOCIO | Antes de habilitar Stripe | Implementado como `void`; reversible en el adaptador |
