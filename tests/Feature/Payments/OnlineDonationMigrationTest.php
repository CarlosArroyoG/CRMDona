...
it('todas las migraciones de la Fase 2 se revierten y se vuelven a aplicar', function (): void {
    ...
    // fiscal + CFDI externo, aviso contable, correo saliente, MFA, solicitudes de pago y aviso del CRM incluye 25 migraciones.
    // Si se usa un paso menor, columna `users.receives_payment_alerts` queda intacta y la prueba falla
